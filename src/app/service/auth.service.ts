...
export class AuthService {
  ...
  api_url='http://donationappke.herokuapp.com/';

  auth_api='https://donationappke.herokuapp.com/api-auth';
  userUrl = 'https://donationappke.herokuapp.com/api/users/';

  oneuser='https://donationappke.herokuapp.com/api/users/user-id/12'
